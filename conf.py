...
BLOG_TITLE = "ప్రాజెక్ట్ చలం"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://projectchalam/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "chillar@avilpage.com"
BLOG_DESCRIPTION = "Free telugu digital library."  # (translatable)
...
PAGES = (
    ("pages/*.html", "", "book.tmpl"),
    ("books/*.html", "books", "book.tmpl"),
    ("authors/*.html", "authors", "book.tmpl"),
)
...
# (translatable)
CONTENT_FOOTER = ' &copy; {date} - ప్రాజెక్ట్ చలం'
